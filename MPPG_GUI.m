...
% MPPG Window
guiCtrl = figure('Resize','on','Units','pixels','Position',[200 300 700 500],'Visible','off','MenuBar','none','name','MPPG Profile Comparison Tool V2.4','NumberTitle','off','UserData',0);
